...
public class D00 extends Solution {
  ...
  // Example class to quickly get started.

  private static final String INPUT_FILE = "2023/inputs/00.txt";
  private static final String LORE_FILE = "2023/lore/00.txt";
